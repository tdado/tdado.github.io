...
![Experiment](/assets/images/m1.png)
...
![Recon1](/assets/images/1.png)
*Stimuli (top row) and their reconstructions from brain data (bottom row).*

![Recon2](/assets/images/2.png)
*Stimuli (top row) and their reconstructions from brain data (bottom row).*
...
![Recon3](/assets/images/3.png)

![Recon4](/assets/images/4.png)
*Stimuli (top row) and their reconstructions from brain data (bottom row).*
